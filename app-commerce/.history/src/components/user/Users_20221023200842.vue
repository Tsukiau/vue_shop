    ...
    <el-card class="box-card">
      ...
      <el-table :data="userList" border stripe>
        ...
        <el-table-column label="操作" width="150px">
          <template slot-scope="scope">
            <!-- 修改按钮 -->
            <el-button type="primary" @click="showEdit(scope.row.id)" icon="el-icon-edit" circle size="mini"></el-button>
            <!-- 删除按钮 -->
...
<script>
import { usersApi, usersStateApi, addUsersApi, examineUsersApi } from '@/api/home'
export default {
  name: 'appUser',
  data() {
    return {
  ...
  methods: {
   ...
   async showEdit(id) {
      ...
      const {data} =await examineUsersApi()
    }
  }
