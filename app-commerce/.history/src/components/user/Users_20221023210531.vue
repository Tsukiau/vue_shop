      ...
      <el-table :data="userList" border stripe>
        ...
        <el-table-column label="操作" width="150px">
          <template slot-scope="scope">
            ...
            <!-- 删除按钮 -->
            <el-button type="danger" icon="el-icon-delete" circle size="mini" @click="delUserId(scope.row.id)">
            </el-button>
            <!-- 分配按钮 -->
...
<script>
import { usersApi, usersStateApi, addUsersApi, examineUsersApi, editUsersStateApi, delUserApi } from '@/api/home'
export default {
  name: 'appUser',
  data() {
    return {
