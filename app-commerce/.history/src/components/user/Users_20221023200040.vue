<template>
  <div>
    ...
    <el-card class="box-card">
      ...
      <el-table :data="userList" border stripe>
        ...
        <el-table-column label="操作" width="150px">
          <template>
            <!-- 修改按钮 -->
            <el-button type="primary" @click="showEdit" icon="el-icon-edit" circle size="mini"></el-button>
            <!-- 删除按钮 -->
    ...
    :visible.sync="editDialogVisible" width="50%" :before-close="handleClose">
      <span>这是一段信息</span>
      <span slot="footer" class="dialog-footer">
        <el-button @click="dialogVisible = false">取 消</el-button>
...
<script>
import { usersApi, usersStateApi, addUsersApi } from '@/api/home'
export default {
  name: 'appUser',
  data() {
    return {
      ...
      editDialogVisible: false, // 控制修改对话的显示
      // 添加用户
      addForm: {
        username: '',
        password: '',
