  ...
  <el-container class="home_container">
    ...
    <el-container>
      ...
      <el-aside :width="isCollapse ? '64px' : '200px'">
        ...
        <el-menu background-color="#313743" :collapse-transition="false" :collapse="isCollapse" text-color="#fff" router
          default-active="/users" active-text-color="#329cff" unique-opened>
          <!-- 一级菜单 -->
