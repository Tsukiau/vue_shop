<template>
  <div class="login">
    <div class="login_box">
      ...
      <!-- 表单 -->
      <el-form ref="loginForm" label-width="0px" class="login_from" v-model="form" :rules="formRules">

        <el-form-item prop="username">
          <el-input v-model="form.name" prefix-icon="el-icon-s-custom" type="text"></el-input>
        </el-form-item>
